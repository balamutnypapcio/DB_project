...
template <> constexpr inline auto Database::qt_create_metaobjectdata<qt_meta_tag_ZN8DatabaseE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'expensesChanged'
        QtMocHelpers::SignalData<void(int)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 4 },
        }}),
        // Signal 'expenseDetailsChanged'
...
void Database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->expensesChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->expenseDetailsChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Database::*)()>(_a, &Database::groupsChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Database::*)(int )>(_a, &Database::expensesChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Database::*)(int )>(_a, &Database::expenseDetailsChanged, 2))
            return;
    }
}
...
// SIGNAL 0
void Database::groupsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Database::expensesChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Database::expenseDetailsChanged(int _t1)
{
